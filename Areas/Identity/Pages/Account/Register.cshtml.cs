...
namespace CoreAspShop.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ApplicationUser { UserName = Input.Email , Name = Input.Name, Email = Input.Email, PhoneNumber = Input.Phone, IsSuperAdmin = Input.IsSAdmin}; 
